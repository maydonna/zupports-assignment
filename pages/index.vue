...
<template>
    <ClientOnly>
        <div class="flex flex-col min-h-screen max-h-screen min-w-screen max-w-screen">
            ...
            <UContainer
                ...
                <div class="flex flex-col items-center w-full">
                    <h1 class="text-xl lg:text-2xl font-bold text-center">
                        ...
                        <span v-gsap.delay-2000.animateText.once.slow class="text-2xl lg:text-4xl text-primary">
                            EAT?
                        </span>
                    </h1>
                    <p
                    ...
                    <UForm ref="form" :schema="schema" :state="state"
                        ...
                        @submit="onSubmit" @keydown.enter="onSubmit">
                        <UFormField name="keyword" class="w-full">
                            <UInput v-model="state.keyword"
                                placeholder="Enter a keyword with location, cuisine, or dish" class="w-full" />
                        </UFormField>
            ...
            <GoogleMap :api-key="config.public.googleMapsApiKey" map-id="636dbb42cdd2aa9d8d1a2432" :center="center"
                :zoom="15" class="hidden lg:flex w-full h-screen">
                <AdvancedMarker v-for="(marker, i) in markers" :key="i" :options="marker" />
            </GoogleMap>
        </div>
    </ClientOnly>
</template>
