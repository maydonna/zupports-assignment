...
<template>
    <div class="flex flex-col min-h-screen max-h-screen min-w-screen max-w-screen">
        ...
        <UContainer class="lg:absolute lg:left-8 lg:top-1/2 lg:-translate-y-1/2 lg:z-10 lg:w-1/2 lg:max-w-lg w-full lg:h-11/12 lg:rounded-lg lg:shadow flex-1 px-4 py-8 lg:overflow-hidden bg-default/85">
            <!-- Search -->
            <ClientOnly>
                <div class="flex flex-col items-center w-full">
                    ...
                    <p class="text-center text-sm lg:text-base text-gray-400 font-medium mt-2 animate-delay-[2500ms] animate-fade-down">
